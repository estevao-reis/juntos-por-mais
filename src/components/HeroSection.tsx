  ...
  return (
    <div className="relative bg-slate-200 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center py-28 md:py-36 flex flex-col items-center">
        <TextGenerateEffect
          words="Juntos com Estevão Reis: Unindo Forças por um Distrito Federal Mais Próspero e Justo."
        ...
        <p className="mt-8 text-xl text-slate-700 max-w-3xl mx-auto">
          ...
          cadastrar, você se torna parte de um movimento por mais oportunidades,
          segurança e qualidade de vida no Distrito Federal.
        </p>
